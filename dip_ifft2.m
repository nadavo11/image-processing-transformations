...
function F = dip_ifft2(I)
    ...
    % Perform the row-wise inverse Fourier transform using matrix multiplication
    sum = I * e1;
    
    % Perform the column-wise inverse Fourier transform using matrix multiplication
    F = (1/(M*N)) * e2 * sum;
end
